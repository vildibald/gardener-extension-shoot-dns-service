...
require (
	...
	k8s.io/kube-aggregator v0.28.10 // indirect
...
// gardener v1.76 related for support k8s 1.28. Remove this after rebasing to gardener v1.80+
replace github.com/gardener/gardener => gitlab.devops.telekom.de/cas-devs/osc/gardener/upstream/gardener v1.76.4-0.20240531100520-ed4af6e4a7cb
